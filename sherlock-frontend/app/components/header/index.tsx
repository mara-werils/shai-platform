...
import ComplianceAINav from './compliance-ai-nav'
    ...
    return (
      <div className=''>
        ...
        <div className='my-1 flex items-center justify-center space-x-1'>
          ...
          {checkRoleAccess(['owner', 'admin', 'editor']) && <AppNav />}
          {checkRoleAccess(['owner', 'admin', 'editor']) && <DatasetNav />}
          {checkRoleAccess(['owner', 'admin', 'editor']) && <ToolsNav className={navClassName} />}
          <ComplianceAINav className={navClassName} />
        </div>
      </div>
    )
  }
