    ...
    >
      <div className='flex h-full grow flex-col'>
        ...
        <div className='grow basis-0 overflow-y-auto px-4 pb-4'>
          ...
          {(isChatMode || !inWorkflow) && (isMainUser || currentWorkspace.role === 'admin' || currentWorkspace.role === 'owner') && <Moderation disabled={disabled} onChange={onChange} />}
