...
type IModal = {
  ...
  outsidePadding?: string // новый проп для внешних отступов
}
  ...
  return (
    <Transition appear show={isShow} as={Fragment}>
      <Dialog as="div" className={classNames('relative', highPriority ? 'z-[1100]' : 'z-[60]', wrapperClassName)} onClose={clickOutsideNotClose ? noop : onClose}>
        ...
        >
          <div className={classNames('flex min-h-full items-center justify-center p-4 text-center', containerClassName, outsidePadding)}>
            <TransitionChild>
              <DialogPanel className={classNames(
                ...
                {title && <DialogTitle
                  ...
                  className={classNames(
                    "title-2xl-semi-bold text-text-primary",
                    closable && "pr-12"
                  )}
                >
                  {title}
