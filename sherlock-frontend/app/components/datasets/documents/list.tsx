...
import { Download02 } from '../../base/icons/src/vender/solid/general'
                ...
                <td>
                  <div className={'group mr-6 flex max-w-[460px] items-center hover:mr-0'}>
                    ...
                    <div className='hidden shrink-0 group-hover:ml-auto group-hover:flex'>
                      ...
                      {doc?.download_path && (
                        <Tooltip popupContent={t('datasetDocuments.list.table.download')}>
                          <a
                            href={doc.download_path}
                            download={doc.name || 'downloaded-file.txt'}
                            onClick={(e) => e.stopPropagation()}
                            className='p-1 rounded-md cursor-pointer hover:bg-state-base-hover'
                          >
                            <Download02 className='w-4 h-4 text-text-tertiary' />
                          </a>
                        </Tooltip>
                      )}
