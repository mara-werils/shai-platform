...
const StepOne = ({
  ...
  const [ocrMethod, setOcrMethod] = useState(crawlOptions.ocr_method || 'off')
          ...
          <div className='flex justify-end'>
            <div className={classNames(s.form)}>
              ...
              {dataSourceType === DataSourceType.FILE && (
                <>
                  <div className='mb-4'>
                    <div className='system-sm-semibold text-text-secondary mb-1'>{t('datasetSettings.form.ocrMethod')}</div>
                    <PureSelect
                      options={[
                      ...
                      onChange={val => {
                        setOcrMethod(val)
                        onCrawlOptionsChange({ ...crawlOptions, ocr_method: val })
                      }}
                    />
                  </div>
                  <FileUploader
