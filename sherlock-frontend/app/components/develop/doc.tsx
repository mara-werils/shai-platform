...
import TemplateRu from './template/template.ru.mdx'
import TemplateAdvancedChatEn from './template/template_advanced_chat.en.mdx'
import TemplateAdvancedChatRu from './template/template_advanced_chat.ru.mdx'
import TemplateWorkflowEn from './template/template_workflow.en.mdx'
import TemplateWorkflowRu from './template/template_workflow.ru.mdx'
import TemplateChatEn from './template/template_chat.en.mdx'
import TemplateChatRu from './template/template_chat.ru.mdx'
...
const Doc = ({ appDetail }: IDocProps) => {
  ...
  const Template = useMemo(() => {
    if (appDetail?.mode === AppModeEnum.CHAT || appDetail?.mode === AppModeEnum.AGENT_CHAT) {
      switch (locale) {
        case 'ru-RU':
          return <TemplateChatRu appDetail={appDetail} variables={variables} inputs={inputs} />
        default:
    ...
    if (appDetail?.mode === AppModeEnum.ADVANCED_CHAT) {
      switch (locale) {
        case 'ru-RU':
          return <TemplateAdvancedChatRu appDetail={appDetail} variables={variables} inputs={inputs} />
        default:
    ...
    if (appDetail?.mode === AppModeEnum.WORKFLOW) {
      switch (locale) {
        case 'ru-RU':
          return <TemplateWorkflowRu appDetail={appDetail} variables={variables} inputs={inputs} />
        default:
    ...
    if (appDetail?.mode === AppModeEnum.COMPLETION) {
      switch (locale) {
        case 'ru-RU':
          return <TemplateRu appDetail={appDetail} variables={variables} inputs={inputs} />
        default:
