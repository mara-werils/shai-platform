...
export const SHAI_MARKETPLACE_API_PREFIX = getStringConfig(
  process.env.NEXT_PUBLIC_SHAI_MARKETPLACE_API_PREFIX,
  DatasetAttr.DATA_SHAI_MARKETPLACE_API_PREFIX,
  'http://localhost:5003/v1',
)
export const SHAI_MARKETPLACE_URL_PREFIX = getStringConfig(
  process.env.NEXT_PUBLIC_SHAI_MARKETPLACE_URL_PREFIX,
  DatasetAttr.DATA_SHAI_MARKETPLACE_URL_PREFIX,
  '',
)

export const AVI_ORGANIZATION_NAME = 'avi'
