const translation = {
  ...
  welcome: 'Bienvenue sur Shai, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Shai Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Shai',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Shai',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Shai et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Shai Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Shai.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Shai. Veuillez contacter votre administrateur pour continuer à utiliser Shai.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Shai Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Shai.',
