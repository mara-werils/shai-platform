const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Учетная запись Shai',
    langGeniusAccountTip: 'Ваша учетная запись Shai и связанные с ней пользовательские данные.',
    ...
    blockAccount: 'Блокировка учетной записи',
    blockAccountTip: 'Блокировка аккаунта ограничит доступ. Вы не сможете авторизоваться до его разблокировки.',
    blockAccountButton: 'Заблокировать аккаунт',
    blockAccountModalTitle: 'Заблокировать аккаунт',
    blockAccountModalDescription: 'Вы действительно хотите заблокировать свой аккаунт?\nПосле блокировки вы не сможете войти, пока его не разблокируют.',
    blockAccountModalCancel: 'Нет, остаться',
    blockAccountModalConfirm: 'Да, заблокировать',
    workspace: 'Рабочее пространство',
    leaveWorkspace: 'Покинуть пространство',
    leaveWorkspaceModalTitle: 'Покинуть рабочее пространство',
    leaveWorkspaceModalDescription: 'Вы действительно хотите удалить свою учетную запись из этого пространства?',
    leaveWorkspaceModalCancel: 'Нет, остаться',
    leaveWorkspaceModalConfirm: 'Да, удалить',
  ...
  members: {
    ...
    pending: 'Ожидание...',
    owner: 'Владелец',
    ownerTip: 'Полный доступ ко всем функциям и настройкам',
    admin: 'Администратор',
    ...
    invitationSentTip: 'Приглашение отправлено, и они могут войти в Shai, чтобы получить доступ к данным вашей команды.',
    ...
    inactive: 'Неактивен',
    banned: 'Заблокирован',
    loginHistoryAction: 'Журнал входов',
    ...
    timeRange7Days: 'Последние 7 дней',
    timeRange14Days: 'Последние 2 недели',
    timeRange1Month: 'Последний месяц',
    timeRange3Months: 'Последние 3 месяца',
    timeRange6Months: 'Последние полгода',
    timeRange1Year: 'Последний год',
    timeRangeAll: 'Все время',
    actions: 'Действия',
    filterAllMembers: 'Все участники',
    filterActiveMembers: 'Активные участники',
    filterBannedMembers: 'Заблокированные участники',
  },
  integrations: {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Хостинговая служба OpenAI, предоставляемая Shai, позволяет вам использовать такие модели, как GPT-3.5. Прежде чем ваша пробная квота будет исчерпана, вам необходимо настроить других поставщиков моделей.',
  ...
  apiBasedExtension: {
    title: 'API-расширения обеспечивают централизованное управление API, упрощая настройку для удобного использования в приложениях Shai.',
  ...
  about: {
    ...
    nowAvailable: 'Shai {{version}} теперь доступен.',
    latestAvailable: 'Shai {{version}} - последняя доступная версия.',
  },
  appMenus: {
    overview: 'Мониторинг',
