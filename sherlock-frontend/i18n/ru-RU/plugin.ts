const translation = {
  ...
  detailPanel: {
    ...
    strategyNum: '{{num}} {{strategy}} ВКЛЮЧЕННЫЙ',
    endpoints: 'Конечные точки',
    modelNum: '{{num}} МОДЕЛИ В КОМПЛЕКТЕ',
    ...
    actionNum: '{{num}} {{action}} ВКЛЮЧЕННЫЙ',
  ...
  installModal: {
    ...
    installFailedDesc: 'Плагин установить не удалось.',
    back: 'Назад',
  ...
  marketplace: {
    ...
    ShaiMarketplace: 'Торговая площадка Sherlock',
    viewMore: 'Подробнее',
    and: 'и',
    discover: 'Обнаруживать',
    verifiedTip: 'Подтверждено Shai',
    partnerTip: 'Подтверждено партнером Shai',
    tagline: 'Подберите подходящие модели, инструменты, агентские стратегии и расширения на маркетплейсе SHAI',
  },
  detail: {
    overviewTitle: 'Обзор',
    sidebar: {
  ...
  difyVersionNotCompatible: 'Текущая версия Shai не совместима с этим плагином, пожалуйста, обновите до минимально необходимой версии: {{minimalDifyVersion}}',
