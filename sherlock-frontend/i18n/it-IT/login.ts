const translation = {
  ...
  welcome: 'Benvenuto su Shai, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Shai Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Shai',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Shai',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Shai e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Shai. Contatta il tuo amministratore per continuare a utilizzare Shai.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Shai Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Shai.',
  licenseInactiveTip: 'La licenza Shai Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Shai.',
