const translation = {
  ...
  toVerifiedTip: {
    ...
    end: 'for the Shai Professional Plan.',
  },
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'I confirm I am enrolled or employed at the institution provided. Shai may request proof of enrollment/employment. If I misrepresent my eligibility, I agree to pay any fees initially waived based on my education status.',
      },
    },
  },
  submit: 'Submit',
  ...
  successTitle: 'You Have Got Shai Education Verified',
  successContent: 'We have issued a 100% discount coupon for the Shai Professional plan to your account. The coupon is valid for one year, please use it within the validity period.',
  rejectTitle: 'Your Shai Educational Verification Has Been Rejected',
  rejectContent: 'Unfortunately, you are not eligible for Education Verified status and therefore cannot receive the exclusive 100% coupon for the Shai Professional Plan if you use this email address.',
