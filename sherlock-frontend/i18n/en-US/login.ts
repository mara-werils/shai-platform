const translation = {
  ...
  error: {
    ...
    tooManyAttempts: 'Too many attempts. Please try again in 5 minutes.',
  },
  license: {
    tip: 'Before starting Shai Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Shai',
  invalid: 'The link has expired',
  explore: 'Explore Shai',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Shai and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Shai Enterprise license for your workspace has expired. Please contact your administrator to continue using Shai.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Shai license server. Please contact your administrator to continue using Sherlock.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Shai Enterprise license for your workspace is inactive. Please contact your administrator to continue using Shai.',
  webapp: {
    login: 'Login',
