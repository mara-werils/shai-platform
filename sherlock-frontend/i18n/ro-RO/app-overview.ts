const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Shai cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Shai.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Shai Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
