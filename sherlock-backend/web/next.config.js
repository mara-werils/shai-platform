...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      {
        source: '/en',
        destination: '/landing/index-en.html',
      },
      {
        source: '/products',
        destination: '/landing/products.html',
      },
      {
        source: '/en/products',
        destination: '/landing/products-en.html',
      },
      {
        source: '/industries',
        destination: '/landing/industries.html',
      },
      {
        source: '/en/industries',
        destination: '/landing/industries-en.html',
      },
      {
        source: '/404',
      ...
      {
        source: '/en/404',
        destination: '/landing/404-en.html',
      },
    ]
  },
  output: 'standalone',
