const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Shai ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Shai i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
