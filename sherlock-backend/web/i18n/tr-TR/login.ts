const translation = {
  ...
  welcome: 'Sherlock\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Sherlock Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Sherlock\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Sherlock Enterprise lisansının süresi doldu. Sherlock\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Sherlock lisans sunucusuna bağlanılamadı. Sherlock\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Sherlock Enterprise lisansı etkin değil. Sherlock\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
