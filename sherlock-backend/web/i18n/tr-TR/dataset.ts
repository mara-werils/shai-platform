const translation = {
  ...
  intro1: 'Bilgi, Sherlock uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Sherlock dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
