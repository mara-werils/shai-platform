const translation = {
  list: {
    title: 'Dokumenti',
    desc: 'Vse datoteke znanja so prikazane tukaj, celotno znanje pa je mogoče povezati s citati Sherlock ali indeksirati prek vtičnika Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Sherlock bo občasno prenesel datoteke iz Notion in dokončal obdelavo.',
      },
    },
    delete: {
