const translation = {
  toVerifiedTip: {
    ...
    end: 'para o Plano Profissional Shai.',
  },
  form: {
    schoolName: {
    ...
    terms: {
      ...
      option: {
        inSchool: 'Eu confirmo que estou matriculado ou empregado na instituição mencionada. A Shai pode solicitar comprovação de matrícula/emprego. Se eu representar indevidamente minha elegibilidade, concordo em pagar quaisquer taxas inicialmente isentas com base no meu status educacional.',
  ...
  successContent: 'Emitimos um cupom de desconto de 100% para o plano Shai Professional na sua conta. O cupom é válido por um ano, por favor, utilize-o dentro do período de validade.',
  rejectTitle: 'A sua verificação educacional Shai foi rejeitada.',
  rejectContent: 'Infelizmente, você não é elegível para o status de Educação Verificada e, portanto, não pode receber o cupom exclusivo de 100% para o Plano Profissional Shai se usar este endereço de e-mail.',
  successTitle: 'Você Tem a Educação Shai Verificada',
