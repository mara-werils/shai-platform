const translation = {
  ...
  welcome: 'Willkommen bei Shai, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Shai Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Shai beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Shai erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Shai angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Shai-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Shai weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Shai Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Shai weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Shai Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Shai weiterhin zu verwenden.',
