const translation = {
  ...
  intro1: 'La Connaissance peut être intégrée dans l\'application Shai',
  ...
  externalAPIPanelDescription: 'L’API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de Shai et récupérer des connaissances de cette base de connaissances.',
