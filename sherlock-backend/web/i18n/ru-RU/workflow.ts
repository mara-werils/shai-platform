const translation = {
  common: {
    ...
    workflowAsToolDisabledHint: 'Опубликуйте последний рабочий процесс и убедитесь, что узел пользовательского ввода подключен, прежде чем настраивать его в качестве инструмента.',
