const translation = {
  ...
  menus: {
    ...
    account: 'Account',
    plugins: 'Plugins',
    exploreMarketplace: 'Marketplace Old',
    marketplaceShai: 'Explore Marketplace',
  ...
  account: {
    ...
    blockAccount: 'Account Blocking',
    blockAccountTip: 'Account blocking will restrict access. You will not be able to log in until it is unblocked.',
    blockAccountButton: 'Block Account',
    blockAccountModalTitle: 'Block Account',
    blockAccountModalDescription: 'Are you sure you want to block your account?\nAfter it is blocked, you will not be able to log in until it is unblocked.',
    blockAccountModalCancel: 'No, stay',
    blockAccountModalConfirm: 'Yes, block',
    workspace: 'Workspace',
    leaveWorkspace: 'Leave Workspace',
    leaveWorkspaceModalTitle: 'Leave Workspace',
    leaveWorkspaceModalDescription: 'Are you sure you want to remove your account from this workspace?',
    leaveWorkspaceModalCancel: 'No, stay',
    leaveWorkspaceModalConfirm: 'Yes, remove',
  ...
  members: {
    ...
    pending: 'Pending...',
    owner: 'Owner',
    ownerTip: 'Full access to all features and settings',
    admin: 'Admin',
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Shai to access your team data.',
    ...
    inactive: 'Inactive',
    banned: 'Banned',
    loginHistoryAction: 'Login History',
    ...
    filterActiveMembers: 'Active Members',
    filterBannedMembers: 'Banned Members',
  },
  feedback: {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Shai allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Shai\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Shai {{version}} is now available.',
    latestAvailable: 'Shai {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
