const translation = {
  ...
  marketplace: {
    ...
    tagline: 'Discover models, tools, agent strategies, extensions and bundles in SHAI Marketplace',
    discover: 'Discover',
    and: 'and',
    ShaiMarketplace: 'Sherlock Marketplace',
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by Sherlock',
    partnerTip: 'Verified by a Sherlock partner',
  },
  detail: {
  ...
  difyVersionNotCompatible: 'The current Shai version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalDifyVersion}}',
  auth: {
    default: 'Default',
    custom: 'Custom',
