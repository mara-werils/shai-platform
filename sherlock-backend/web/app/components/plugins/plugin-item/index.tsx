...
const PluginItem: FC<Props> = ({
  ...
  const hideDifyMarketplaceLink = process.env.NEXT_PUBLIC_ORGANIZATION_NAME === AVI_ORGANIZATION_NAME
    ...
    >
      ...
      <div className='mb-1 mt-1.5 flex h-4 items-center gap-x-2 px-4'>
        ...
        <div className='flex shrink-0 items-center'>
          ...
          {!hideDifyMarketplaceLink && source === PluginSource.marketplace && enable_marketplace
            && <>
