...
const ChatWithHistory: FC<ChatWithHistoryProps> = ({
  ...
  return (
    <div className={cn(
      ...
      <div className={cn('relative grow p-2', isMobile && 'h-[calc(100svh_-_56px)] p-0')}>
        {isSidebarCollapsed && (
          <div
            className={cn(
        ...
        <div className={cn('flex h-full flex-col overflow-hidden border-[0,5px] border-components-panel-border-subtle bg-chatbot-bg max-height-mobile', isMobile ? 'rounded-t-2xl' : 'rounded-2xl')}>
          {!isMobile && <Header />}
          {appChatListDataLoading && (
            <Loading type='app' />
          )}
