...
const Question: FC<QuestionProps> = ({
  ...
  return (
    <div className='mb-2 flex justify-end last:mb-0'>
      <div className={cn('group relative mr-4 flex max-w-full items-start pl-4', isEditing && 'flex-1')}>
      ...
      <div className='h-10 w-10 shrink-0'>
        {
          questionIcon || (
            <div className='h-full w-full rounded-full border-[0.5px] border-black/5'>
              {isSamrukPath
                ? <img src="/logo-other/samruk-avatar.jpg" className="w-full h-full rounded-full" alt="app logo"/>
