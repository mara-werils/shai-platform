...
class PluginService:
    ...
    @staticmethod
    def fetch_marketplace_pkg(tenant_id: str, plugin_unique_identifier: str,
                              use_shai_marketplace: bool = False,) -> PluginDeclaration:
        """
        ...
        try:
            ...
            pkg = download_plugin_pkg(plugin_unique_identifier, use_shai_marketplace)
            response = manager.upload_pkg(
                tenant_id,
                pkg,
                verify_signature=features.plugin_installation_permission.restrict_to_marketplace_only,
    ...
    @staticmethod
    def install_from_marketplace_pkg(tenant_id: str, plugin_unique_identifiers: Sequence[str], use_shai_marketplace: bool = False):
        """
