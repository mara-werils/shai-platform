...
class WorkflowService:
    ...
    @staticmethod
    def get_by_app_model(session: Session, app_model: App) -> Optional[Workflow]:
        stmt = select(Workflow).where(Workflow.id == app_model.workflow_id, Workflow.tenant_id == app_model.tenant_id)
