...
from controllers.console.explore.wraps import installed_app_roles_required
...
class ChatApi(InstalledAppResource):
    # @installed_app_roles_required([TenantAccountRole.OWNER, TenantAccountRole.ADMIN])
    def post(self, installed_app):
        app_model = installed_app.app
