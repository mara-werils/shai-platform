...
class App(Base):
    ...
    max_runs_per_day: Mapped[int] = mapped_column(nullable=True)
    access_type: Mapped[str] = mapped_column(String(255), nullable=False, server_default=sa.text("'all_team_members'::character varying"),
...
class AccountAppJoin(Base):
    __tablename__ = "account_app_join"
    __table_args__ = (db.PrimaryKeyConstraint("id", name="account_app_join_pkey"),)
