...
class Dataset(Base):
    ...
    OCR_PROCESSING_LIST = ["off", "docling", None]
    ...
    ocr_method = mapped_column(sa.String(255), nullable=False, server_default=db.text("'off'::character varying"))
    @property
...
class Document(Base):
    ...
    # ocr
    ocr_method = mapped_column(String(255), nullable=False, server_default=db.text("'off'::character varying"))
    ...
    def download_path(self):
        ...
        url = file_helpers.get_signed_file_url(upload_file_id=file_id)
        return url
