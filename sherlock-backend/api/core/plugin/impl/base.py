...
from core.plugin.entities.plugin_daemon import PluginDaemonBasicResponse, PluginDaemonError, PluginDaemonInnerError, PluginListResponse
...
class BasePluginClient:
    ...
    def _request_with_plugin_daemon_response(
        ...
        try:
            ...
            if type_.__name__ == PluginListResponse.__name__ and isinstance(json_response.get("data"), list):
                json_response["data"] = {"list": json_response["data"], "total": len(json_response["data"])}
