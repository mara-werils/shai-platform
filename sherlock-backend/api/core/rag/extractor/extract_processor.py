...
from core.rag.extractor.entity.ocr_method import OcrMethod
        ...
        if extract_setting.datasource_type == DatasourceType.FILE:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if etl_type == "Unstructured":
                    ...
                    if extract_setting.ocr_method == OcrMethod.DOCLING:
                        ocr_api_url = dify_config.OCR_API_URL or ""
                        extractor = OcrExtractor(ocr_api_url, file_path, file_extension)
