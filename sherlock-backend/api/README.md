...
1. Start the docker-compose stack
   ...
   docker compose -f docker-compose.middleware.yaml --profile weaviate -p shai up -d
   cd ../api
   ```
...
1. Create environment.
   ...
   SHAI API service uses [UV](https://docs.astral.sh/uv/) to manage dependencies.
